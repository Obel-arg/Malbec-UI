...
export const Default: Story = {
  parameters: {
    docs: {
      source: {
        code: `import { Button, DropdownMenu } from "@obel-arg/malbec-ui";
      ...
      <DropdownMenu.Group>
        ...
        <DropdownMenu.Sub>
          <DropdownMenu.SubTrigger>
            <span className="flex-1 text-left">Invite users</span>
          </DropdownMenu.SubTrigger>
...
import { Button, DropdownMenu } from "@obel-arg/malbec-ui";
