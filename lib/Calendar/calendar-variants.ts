...
export const calendarNavButtonVariants = cva([
  ...
  "ui:inline-flex ui:size-7 ui:shrink-0 ui:items-center ui:justify-center ui:rounded-md ui:bg-transparent ui:p-0 ui:text-text-default ui:outline-none ui:cursor-pointer",
...
export const calendarDayButtonBaseVariants = cva([
  "ui:inline-flex ui:size-9 ui:items-center ui:justify-center ui:rounded-md ui:cursor-pointer",
